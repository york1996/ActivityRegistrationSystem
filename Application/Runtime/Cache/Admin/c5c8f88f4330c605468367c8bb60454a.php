...
<div class="am-container">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="am-container">
                <form class="am-form-inline" method="post" action="/wxtest/index.php/Admin/User/update"  enctype="multipart/form-data">
                    ...
                    <div class="am-form-group">
                        <label for="password">组织</label>
                        <input type="text" class="form-control" id="password" placeholder="组织" name="org" value="<?php echo ($vo["org"]); ?>">
                    </div>
                    <br>
                    <br>

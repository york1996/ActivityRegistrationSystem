...
<div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">修改活动</strong> / <small>编辑活动项目</small></div>
</div>

<div class="am-container">
    <form class="am-form" method="post" action="/wxtest/index.php/Admin/Active/Edit" enctype="multipart/form-data">
        <div class="am-form-group">
            <label for="title">标题</label>
            <div>
                <input type="text" id="title" name="title" placeholder="标题" value="<?php echo ($vo["title"]); ?>">
            </div>
        </div>
        <div class="am-form-group">
            <label>组织</label>
            <div>
                <input type="text"  name="org" placeholder="组织" value="<?php echo ($vo["org"]); ?>">
            </div>
        </div>
        <div class="am-form-group">
            <label for="container">说明</label>
            <div>
                <script id="container" name="content" type="text/plain"><?php echo ($vo["content"]); ?>
                </script>
            </div>
        </div>
        <div class="am-form-group">
            ...
            <div>
                <input id="time" type="text" name="time" class="am-form-field" placeholder="日历" data-am-datepicker readonly required value="<?php echo (date('Y-m-d',$vo["time"])); ?>"/>
            </div>
        </div>

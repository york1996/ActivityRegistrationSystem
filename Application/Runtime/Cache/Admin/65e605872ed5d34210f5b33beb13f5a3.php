...
<div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">管理个人用户</strong> / <small>在这里可以管理个人用户账号</small></div>
</div>
...
<div class="am-container">
    ...
    <div class="table-responsive">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo ($vo["orgs"]); ?></td>
                <td><a href="/wxtest/index.php/Admin/User/edit/id/<?php echo ($vo["id"]); ?>">修改</a> <a href="/wxtest/index.php/Admin/User/del/id/<?php echo ($vo["id"]); ?>">删除</a></td>

...
<div class="am-g">
    ...
    <div class="am-container">
        <a href="/wxtest/index.php/Admin/Active/Add" class="am-btn am-btn-default">添加活动</a>
    </div>
    <div class="am-u-sm-12">
        <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
            <tr>
                <th width="30%">标题</th><th>组织</th><th>截止日期</th><th>活动介绍</th><th>操作</th><th>状态</th>
            </tr>
            </thead>
            <tbody>
                    ...
                    <td>
                        <div class="am-btn-toolbar">
                            <div class="am-btn-group am-btn-group-xs">
                                <a href="/wxtest/index.php/Admin/Active/Edit/id/<?php echo ($vo["id"]); ?>" class="am-btn am-btn-default am-btn-xs"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                                <a href="/wxtest/index.php/Admin/Active/Del/id/<?php echo ($vo["id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                            </div>
                        </div>
                    </td>
                    <td>
                        <?php if($vo["state"] == 1): ?><a href="/wxtest/index.php/Admin/Active/off/id/<?php echo ($vo["id"]); ?>" class="am-btn am-btn-default am-btn-xs"><span class="am-icon-archive"></span> 已通过</a><?php endif; ?>
                        <?php if($vo["state"] == 0): ?><a href="/wxtest/index.php/Admin/Active/on/id/<?php echo ($vo["id"]); ?>" class="am-btn am-btn-danger am-btn-xs"><span class="am-icon-archive"></span> 未审核</a><?php endif; ?>
                    </td>

...
<div class="am-g">
    <div class="am-u-sm-12">
        <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
            <tr>
                <th>姓名</th><th>手机</th><th>报名日期</th><th>报名理由</th><th>微信</th><th>状态</th>
            </tr>
            </thead>
            <tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><button class="am-btn am-btn-default am-btn-xs" data-am-modal="{target: '#my-alert-<?php echo ($vo["id"]); ?>'}">查看理由</button></td>
                    <div class="am-modal am-modal-alert" tabindex="-1" id="my-alert-<?php echo ($vo["id"]); ?>">
                        <div class="am-modal-dialog">
                            <div class="am-modal-hd">报名理由</div>
                    ...
                    <td>
                        <div class="am-btn-toolbar">
                            <div class="am-btn-group am-btn-group-xs">
                               <?php if($vo["state"] == 0): ?><a href="/wxtest/index.php/Admin/Signup/on/id/<?php echo ($vo["id"]); ?>" class="am-btn am-btn-danger am-btn-xs"><span class="am-icon-pencil-square-o"></span> 未审核,点击审核</a><?php endif; ?>
                                <?php if($vo["state"] == 1): ?><a href="/wxtest/index.php/Admin/Signup/off/id/<?php echo ($vo["id"]); ?>" class="am-btn am-btn-default am-btn-xs"><span class="am-icon-pencil-square-o"></span> 已审核,点击关闭</a><?php endif; ?>
                            </div>
                        </div>
                    </td>

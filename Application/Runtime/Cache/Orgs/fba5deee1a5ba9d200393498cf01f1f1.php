...
<div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><<?php echo ($data["title"]); ?>>活动报名信息</strong> / <small>共有<?php echo ($people); ?>人报名</small></div>
</div>

<div class="am-g">
    <div class="am-u-sm-12">
        <a href="/wxtest/index.php/Orgs/Signup/excel_runexport/id/<?php echo ($class); ?>" class="am-btn am-btn-default">导出Excel表</a>
        <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
            <tr>
                <th>姓名</th><th>手机</th><th>报名日期</th><th>报名理由</th><th>状态</th>
            </tr>
            </thead>
            <tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        <button class="am-btn am-btn-default am-btn-xs" data-toggle="modal" data-target="#alert-<?php echo ($vo["id"]); ?>">报名理由</button>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">报名理由</h4>
                                    </div>
                    ...
                    <td>
                        <div class="am-btn-toolbar">
                            <div class="am-btn-group am-btn-group-xs">
                               <?php if($vo["state"] == 0): ?><a href="/wxtest/index.php/Orgs/Signup/on/id/<?php echo ($vo["id"]); ?>" class="am-btn am-btn-danger am-btn-xs"><span class="am-icon-pencil-square-o"></span> 未审核,点击审核</a><?php endif; ?>
                                <?php if($vo["state"] == 1): ?><a href="/wxtest/index.php/Orgs/Signup/off/id/<?php echo ($vo["id"]); ?>" class="am-btn am-btn-default am-btn-xs"><span class="am-icon-pencil-square-o"></span> 已审核,点击关闭</a><?php endif; ?>
                            </div>
                        </div>
                    </td>

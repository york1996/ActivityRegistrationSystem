...
<div class="am-g">
    ...
    <div class="am-container">
        <a href="/wxtest/index.php/Orgs/Active/Add" class="am-btn am-btn-default">添加活动</a>
    </div>
                    ...
                    <td>
                        <div class="am-btn-toolbar">
                            <div class="am-btn-group am-btn-group-xs">
                                <a href="/wxtest/index.php/Orgs/Active/Edit/id/<?php echo ($vo["id"]); ?>" class="am-btn am-btn-default am-btn-xs"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                                <a href="/wxtest/index.php/Orgs/Active/Del/id/<?php echo ($vo["id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                            </div>
                        </div>
                    </td>
                    <td>
                        <?php if($vo["state"] == 1): ?><span class="am-badge am-badge-success am-radius">已审核通过</span><?php endif; ?>
                        <?php if($vo["state"] == 0): ?><span class="am-badge am-badge-danger am-radius">未审核</span><?php endif; ?>
                    </td>

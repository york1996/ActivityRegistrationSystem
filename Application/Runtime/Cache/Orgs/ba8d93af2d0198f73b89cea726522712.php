...
<div class="am-container">
    <form class="am-form" method="post" action="/wxtest/index.php/Orgs/Active/Edit" enctype="multipart/form-data">
        ...
        <div class="am-form-group">
            <label>组织</label>
            <div>
                <input type="text"  name="org" placeholder="编辑" value="<?php echo ($vo["org"]); ?>">
            </div>
        </div>
        <div class="am-form-group">

...
<header class="am-topbar admin-header">
    <div class="am-topbar-brand">
        <strong>活动报名系统<span class="sr-only">(current)</span></strong> <small>个人中心</small>
    </div>
    ...
    <div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
        <div class="am-offcanvas-bar admin-offcanvas-bar">
            <ul class="am-list admin-sidebar-list">
                ...
                <li><a href="<?php echo U('Active/Index');?>"><span class="am-icon-send"></span> 活动列表</a></li>
                <li><a href="<?php echo U('My/Index');?>"><span class="am-icon-list"></span> 我的报名</a></li>
                <li><a href="<?php echo U('Info/Index');?>"><span class="am-icon-crop"></span> 个人信息修改</a>
            ...
            <div class="am-panel am-panel-default admin-sidebar-panel">
                <div class="am-panel-bd">
                    ...
                    <p>用户报名需要在对应组织审核后才可以参与活动,请认真填写报名理由.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="am-u-sm-12">
        <table class="am-table am-table-striped am-table-hover table-main">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        <button class="am-btn am-btn-default am-btn-xs" data-toggle="modal" data-target="#alert-<?php echo ($vo["id"]); ?>">活动介绍</button>
                        <div class="modal fade" id="alert-<?php echo ($vo["id"]); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    ...
                    <td>
                        <?php if($vo["time"] >= $now): ?><button class="am-btn am-btn-default am-text-danger am-btn-xs" data-am-modal="{target: '#sign-<?php echo ($vo["id"]); ?>'}">点击报名</button>
                        <?php else: ?><button class="am-btn am-btn-default am-btn-xs" disabled>已截止报名</button><?php endif; ?>
                        <div class="am-modal am-modal-alert" tabindex="-1" id="sign-<?php echo ($vo["id"]); ?>">
                                    ...
                                    <form class="am-form am-form-horizontal" action="sign" method="post">
                                        <div class="am-form-group">
                                            ...
                                            <div class="am-u-sm-10">
                                                <input type="text" name="name" disabled placeholder="输入你的姓名" value="<?php echo ($_SESSION['name']); ?>">
                                                <input type="hidden" name="name" placeholder="输入你的姓名" value="<?php echo ($_SESSION['name']); ?>">
                                        ...
                                        <input type="hidden" value="<?php echo ($vo["id"]); ?>" name="classify">
                                        <input type="hidden" value="<?php echo ($vo["title"]); ?>" name="title">
                                        <input type="hidden" value="<?php echo ($vo["org"]); ?>" name="org">

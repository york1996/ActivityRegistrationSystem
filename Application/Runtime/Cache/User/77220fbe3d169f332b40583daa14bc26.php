...
<div class="am-g">
    <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
        <li><span class="am-icon-btn am-icon-file-text"></span><br>全站活动<br><?php echo ($vo); ?></li>
        <li><span class="am-icon-btn am-icon-briefcase"></span><br>组织数<br><?php echo ($wo); ?></li>
        <li><span class="am-icon-btn am-icon-user-md"></span><br>用户数<br><?php echo ($no); ?></li>
        <li><span class="am-icon-btn am-icon-send"></span><br>全站报名<br><?php echo ($co); ?></li>
    </ul>
</div>

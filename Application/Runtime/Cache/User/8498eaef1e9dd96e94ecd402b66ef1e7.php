...
<div class="am-g">
    ...
    <form class="am-form" method="post" action="/wxtest/index.php/User/Info/update">
        ...
        <div class="am-input-group">
            ...
            <input type="text" class="am-form-field" name="org" placeholder="所属组织" value="<?php echo ($vo["org"]); ?>">
        </div>
        <br />
        <div class="am-input-group">

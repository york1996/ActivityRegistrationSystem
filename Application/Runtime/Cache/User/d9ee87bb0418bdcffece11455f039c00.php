...
<div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">我的报名</strong> / <small>在这里可以看到我参加报名的活动</small></div>
</div>
...
<div class="am-g">
    <div class="am-u-sm-12">
        <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
            <tr>
                <th width="30%">标题</th><th>组织</th><th>报名日期</th><th>状态</th>
            </tr>
            </thead>
            <tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        <?php if($vo["state"] == 1): ?><span class="am-badge am-badge-success">已通过审核</span><?php endif; ?>
                        <?php if($vo["state"] == 0): ?><span class="am-badge am-badge-danger">未通过审核</span><?php endif; ?>
                    </td>
